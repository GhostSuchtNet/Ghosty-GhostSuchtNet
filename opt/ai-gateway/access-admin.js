...
["tool.hash", "Hash / Encoding"],
["tool.units", "Einheiten umrechnen"],
["tool.math", "Mathematik"],
["tool.statistics", "Statistik"],
["tool.formula", "Formel-System"],
["tool.translate", "Übersetzung"],
["tool.grammar", "Rechtschreibung / Grammatik"],
["tool.data.validate", "JSON / YAML / XML"],
["tool.files.convert", "Dateikonvertierung"],
["tool.pdf", "PDF-Werkzeuge"],
["tool.archive", "Archive"],
["tool.metadata", "Metadaten"],
["tool.image", "Bild-Werkzeuge"],
["tool.spreadsheet", "Tabellen-Werkzeuge"],
["tool.code.analyze", "Codeanalyse"],
["tool.diff", "Diff / Patch"],
["tool.knowledge", "Lokaler Wissensspeicher"],
["tool.http", "HTTP / DNS Inspector"],
["tool.qr", "QR / Barcode"],
["tool.diagram", "Diagramme"],
